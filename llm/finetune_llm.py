...
This script finetunes a small GPT-2 model (distilgpt2) on an SSE dataset created by taking sentences
from the course content, and saves the finetuned model.
